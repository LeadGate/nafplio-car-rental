...
const AboutPage = () => {
  ...
  const articleSchema =
  {
    ...
    "description": "Nafplio Car Rental is an independent comparison resource for car rentals in Nafplio, the first capital of modern Greece in Argolis, Peloponnese. Nafplio",
  ...
  return (
    <Layout>
      ...
      <Breadcrumbs items={[{ label: "About Page" }]} />

      <HeroSection
        title="How We Built This Nafplio Rental Comparison"
        subtitle={<><p className="text-white drop-shadow-md">Nafplio Car Rental is an independent comparison resource for car rentals in Nafplio, the first capital of modern Greece in Argolis, Peloponnese. Nafplio Car Rental is not a rental agency, and Nafplio Car Rental uses official sources, on-the-ground checks, and broker disclosures to compare the local market against international booking platforms.</p></>}
        image="/8.webp"
      ...
      <Section
        ...
        title="Who We Are"
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Nafplio Car Rental is published by a small remote editorial team, and the primary editor is Sarmat. Nafplio Car Rental research uses Greek-language sources such as anagnostis.org, argolikeseidiseis.gr, and kodiko.gr, plus official institutions such as ELSTAT and the Δήμος Ναυπλιέων when a statistic needs municipal confirmation.</p>
          <p className="text-gray-700 mb-4 leading-relaxed">The editorial process is not desk-only, and the Nafplio Car Rental team has driven the Athens-to-Nafplio corridor during the latest travel season to verify toll plazas and parking access near Akti Miaouli. The comparison does not accept agency payments for ranking priority, and the published order is reviewed quarterly with source notes for each agency mention.</p>
          <WarningBox><p>⚠️ <strong>Warning:</strong> Nafplio Car Rental does not treat a high review score as proof of compliance, because Greek road and insurance rules can still apply after an accident. Under Bank of Greece Act 195/3 and Law 5209/2025, an insurer may examine statutory-third-party liability, excess/deductible, and preauthorisation conditions before approving a claim.</p></WarningBox>
      </Section>
      ...
      <Section
        ...
        alt
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Nafplio Car Rental builds each comparison from named data sources, and every paragraph below is self-contained so readers can verify one subject at a time.</p>
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">Our insurance notes reflect Bank of Greece Act 195/3, and Nafplio Car Rental treats terms such as CDW, SCDW, FDW, WUG, franchise, zero excess, full coverage, and excess/deductible as contract language rather than marketing language. Rental desks in Nafplio may also request a preauthorisation on the card, and the final settlement can depend on the rental agency’s own terms even when statutory-third-party liability is included.</p>
          <InfoBox><p>💡 <strong>Tip:</strong> Nafplio Car Rental readers comparing agencies should ask whether a quoted rate includes CDW, SCDW, or FDW, because some desks advertise a low daily base and then add a higher franchise or deductibles at pickup. A printed voucher and the agency’s written terms are more useful than a verbal promise.</p></InfoBox>
      </Section>
      ...
      <Section
        ...
        alt
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Nafplio Car Rental uses affiliate links, and a completed booking through a partner may generate a commission at no extra cost to the reader. The commission supports research and does not change ranking order, while direct contact details for local agencies remain informational rather than affiliate-based.</p>
          <p className="text-gray-700 mb-4 leading-relaxed">Nafplio Car Rental works with Localrent, Auto Europe, Sunny Cars, and Booking, and the site also references local operators such as Staikos Rent a Car (rentacarnafplio.gr) with owner Christos Bouchoutsos, Bounos Car Rental (bounos-carrental.com), Makris Car Rental since 1986, Alma Car Rental (almacar.gr), Base Rent a Car (nafpliorentacar.gr), Euro Rent a Car (eurorentacar.eu, since 1986), Imperial Car Rental, Hermes Travel, Stamou Car Rental, Aspida Car Rental, G.A. Car Rental with owner Mr Gavriil, and Ride &amp; Drive.</p>
          <WarningBox><p>⚠️ <strong>Warning:</strong> Nafplio Car Rental treats broker prices as published offers, not guaranteed local-agency rates, because availability can change before pickup. For example, an “Imperial” €18/day Ford Fiesta quote should be read as an unverified broker rate unless the desk confirms the same car, insurance package, and pickup date in writing.</p></WarningBox>
      </Section>
